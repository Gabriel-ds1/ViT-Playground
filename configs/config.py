...
class TrainViTConfig:
    ...
    cosine_eta_min: float = 1e-4 # the lowest LR at plateau for scheduler
    ...
    save_npy: bool = True # Whether to save npy files alongside visualizations
    # whether to log tensorboard/weights and biases
    log_backend: str = ""  # 'wandb', 'tensorboard', 'both', or leave empty for none
